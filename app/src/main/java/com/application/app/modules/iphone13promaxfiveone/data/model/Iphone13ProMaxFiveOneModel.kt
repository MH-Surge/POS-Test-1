package com.application.app.modules.iphone13promaxfiveone.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

data class Iphone13ProMaxFiveOneModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtEmpoyeeInsight: String? =
      MyApp.getInstance().resources.getString(R.string.msg_empoyee_insight)
