package com.application.app.modules.addnewitemfinishedgoodsone.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

data class AddNewItemFinishedGoodsOneModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtMeasureIn: String? = MyApp.getInstance().resources.getString(R.string.lbl_measure_in)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var etGroup139Value: String? = null,
  /**
   * TODO Replace with dynamic value
   */
