package com.application.app.modules.iphone13promaxfifteenone.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

data class Iphone13ProMaxFifteenOneModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtYesOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_yes)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var etGroup265Value: String? = null,
  /**
   * TODO Replace with dynamic value
   */
